...
from app.modules.exams.schemas import ExamCreateIn, ExamPublic, ExamSubmitOut, WritingPartSubmitIn
...
async def submit_writing_exam(
    ...
    result = await services.submit_writing_exam(db, current_user, exam_id, [p.model_dump() for p in payload])
