...
import { useStartAttemptMutation, useTestDetailsQuery } from '../api/use-ielts';
import { getModuleAttemptPath, getModuleSessionPath } from '../utils/module-meta';
import { IeltsDetailSkeleton } from '../skeleton';
import { IeltsPageHeader, IeltsStatusChip, InsightListCard, MetricCard } from '../components';

type ModuleTestDetailsViewProps = {
  module: ActiveIeltsModule;
};

export function ModuleTestDetailsView({ module }: ModuleTestDetailsViewProps) {
  const { tx } = useLocales();
