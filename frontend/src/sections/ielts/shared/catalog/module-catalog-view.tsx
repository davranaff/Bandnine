...
import { useModuleTestsQuery } from '../api/use-ielts';
import {
  getModuleAttemptPath,
  getModuleSessionPath,
  getModuleTestPath,
} from '../utils/module-meta';
import { IeltsCatalogSkeleton } from '../skeleton';
import { IeltsPageHeader, ModuleTestCard } from '../components';

type IeltsModuleCatalogViewProps = {
  module: ActiveIeltsModule;
};

export function IeltsModuleCatalogView({ module }: IeltsModuleCatalogViewProps) {
  const { tx } = useLocales();
  ...
  return (
    <Container maxWidth="lg">
      <IeltsPageHeader title={moduleTitle} description={moduleDescription} />
      ...
      {isLoading ? <IeltsCatalogSkeleton /> : null}
